...
<template>
    <aside data-sidebar-content class="nav-sidebar flex flex-col h-full" @click.stop>
        ...
        <!-- Top Bar with Hamburger and Logo/Title -->
        <div class="bg-pkl-base-orange px-4 py-3 flex items-center gap-3 border-b border-orange-400">
            <!-- Hamburger Button -->
            <button
                type="button"
            ...
            <div class="flex items-center gap-3 flex-1">
                <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center flex-shrink-0">
                    <img src="/images/assets/LOGO-PKL_REV8.png" class="w-8 h-8 object-contain" alt="Logo PKL 65">
                </div>
                <div class="flex-1">
                    <h2 class="text-white font-semibold text-sm leading-tight">Admin Panel PKL 65</h2>
                    <p class="text-orange-100 text-[10px]">Tahun Ajaran 2025/2026</p>
                </div>
            </div>
        </div>
        ...
        <!-- Beranda Diseminasi Button at Bottom -->
